...
class Crypt extends BasicWeChat
{
     ...
     * @throws LocalCacheException
     */
    public function userInfo(string $code, string $iv, string $encryptedData): array
    {
     ...
     * @param string|null $transaction_id 微信支付订单号
     ...
     * @throws LocalCacheException
     */
    public function getPaidUnionId(string $openid, string $transaction_id = null, string $mch_id = null, string $out_trade_no = null): array
    {
